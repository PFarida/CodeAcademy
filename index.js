var clockRadius = document.getElementsByClassName("clockRadius")[0];
        ...
        function time() {
            ...
            document.getElementsByClassName("Second")[0].style.transform = 'rotate(' + seconds * 6 + 'deg)';
            document.getElementsByClassName("Min")[0].style.transform = 'rotate(' + mins * 6 + 'deg)';
            document.getElementsByClassName("Hours")[0].style.transform = 'rotate(' + (hours * 30 + mins * 0.5) + 'deg)';
            console.log(document.getElementsByClassName("Second")[0].style.transform);
        }
